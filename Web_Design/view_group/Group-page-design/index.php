   ...
   <div class="container">
            ...
            if ($groupInfo) {
               ...
               foreach ($groupInfo as $group) {
                  ...
                  $added_member_query = "SELECT COUNT(group_member.member) as Member FROM group_member, group_details
                        WHERE group_member.group_id = group_details.Group_ID and group_member.Group_ID= ? and group_member.request='YES' ";
      ...
      <div class="right_sidebar">
         <div class="imp-links">
            ...
            <a href="/Web_Design/Profile_Edit/view_profile.php#post"><img src="/Home_pages/image/icons/activity.png" class="friend">&nbsp Activity</a>
