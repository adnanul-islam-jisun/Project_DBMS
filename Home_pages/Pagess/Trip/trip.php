    ...
    <div class="trip_main">
        ...
        <div class="img_links">
            <div class="image_section">
                ...
                <?php echo '<img src="/Home_pages/uploads/' . $view_group['prof_text'] . '" alt="Profile Photo" style="width:250px;height: 300px;">'; ?>
            ...
            <header  style="  margin-left: 50px; ">
                ...
                if ($details_member !== null) {
                    ...
                    foreach ($details_member as $detail_m) {
                        ...
                        if ($detail_m["username"] != $_SESSION["username"]) {
                            echo '<form method="post" action="trip.php">';
                            echo '<input type="hidden" name="member" value="' . $detail_m['username'] . '">';
                            echo '<input type="hidden" name="action" value="reject">';
                            echo '<button class="reject-button">Remove</button>';
                            echo '</form>';
                        }
                        // echo '</div>';
                        echo '</li>';
