...
if (isset($_POST['authorizeSubmit'])) {
    ...
    if (isset($_SESSION['otp']) && $_SESSION['otp'] == $enteredOTP) {
        ...
        if (!empty($_SESSION['email'])) {
            ...
            header('Location: /login_signup_page/Home_pages/home.php');
...
<body>
    ...
    <div class="container">
        <h1><a href="/login_signup_page/Home_pages/home.php"><img src="/Home_pages/image/icons/next.png" alt="" class="ing_rotat" ></a>
